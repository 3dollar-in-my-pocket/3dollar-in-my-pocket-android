...
class MyStoreRecyclerAdapter : PagedListAdapter<Store, BaseViewHolder<ItemMyRestaurantBinding, Store>>(object : DiffUtil.ItemCallback<Store?>() {
    ...
    override fun onBindViewHolder(holder: BaseViewHolder<ItemMyRestaurantBinding, Store>, position: Int) {
        holder.bind(getItem(position) ?: Store(), null)
    }
}