...
import com.zion830.threedollars.databinding.ItemMedalInfoBinding
import com.zion830.threedollars.repository.model.v2.response.my.Medal
import zion830.com.common.base.BaseRecyclerView

class MedalInfoRecyclerAdapter : BaseRecyclerView<ItemMedalInfoBinding, Medal>(R.layout.item_medal_info) {
